...
The result shows symbols:
	...
	* a '-' means one of the digits is in the code to guess, but not a the correct place
	* a '+' means one of the digits is in the code to guess, AND a the correct place
